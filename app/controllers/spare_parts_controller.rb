class SparePartsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @spare_part.save
        format.html { redirect_to spare_part_url(@spare_part), notice: "Spare part was successfully created." }
  ...
  def update
    respond_to do |format|
      if @spare_part.update(spare_part_params)
        format.html { redirect_to spare_part_url(@spare_part), notice: "Spare part was successfully updated." }
  ...
  private
    ...
    def spare_part_params
      params.require(:spare_part).permit(:name, :category_id, :description, :tags, :images, :files, :manufacturer, :kit_id, :weight)
    end
end
